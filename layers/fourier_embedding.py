...
class FourierEmbedding(nn.Module):
    ...
    def forward(self,
        ...
        if continuous_inputs is None:
            ...
            # [batch_size * steps, input_dim] -> [batch_size * steps, input_dim, num_freq]
            ...
            # [batch_size * steps, input_dim, num_freq] -> [batch_size * steps, input_dim, 2*num_freq+1]
            ...
            for i in range(self.input_dim):
                # [batch_size * steps, input_dim, hidden_dim]
                continuous_embs[i] = self.mlps[i](x[:, i])
            # [input_dim, batch_size * steps, hidden_dim] -> [batch_size * steps, hidden_dim]
